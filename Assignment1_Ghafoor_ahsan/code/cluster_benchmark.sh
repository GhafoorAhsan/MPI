...
# Strong scaling: L=4, worst-case "ZZZZ", np = 1,2,4,8,16,32,62
echo "1" > /tmp/hf1
...
# Random (non-extreme) length-4 passwords, np=16
for PW in 7Bhy mZ4x 3mQa 2xTk Q5vN 9fQ2 Tp7Z L8pR Wc3J Kx9F; do
  FILE="./files/rand_${PW}"
...
# check_interval sweep at np=62, L=4 worst-case
